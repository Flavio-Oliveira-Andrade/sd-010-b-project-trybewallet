...
const mapDispatchToProps = (dispatch) => ({
  usuario: (email) => dispatch(action(email)), // esse usuario(nome que dei) é UMA FUNÇÃO, tanto que botei assim no propTypes. E eu irei chamar essa função dentro da função SUBMIT.
